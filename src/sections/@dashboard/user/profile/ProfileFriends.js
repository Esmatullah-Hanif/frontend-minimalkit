...
import { Box, Card, Link, Stack, Avatar, MenuItem, IconButton, Typography, InputAdornment } from '@mui/material';
// _mock
  ...
  return (
    <>
      <Stack spacing={3} justifyContent="space-between" direction={{ xs: 'column', sm: 'row' }} sx={{ my: 5 }}>
        <Typography variant="h4">Key people</Typography>
